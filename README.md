...
3. Right click the `PropertyDB` project and select publish. Select your local machine and name the database `PropertyDB`, save the profile, and select publish.
